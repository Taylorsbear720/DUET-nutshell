...
const int DIFFTEST_REG = sizeof(arch_reg_state_t)/ sizeof(uint64_t);
#else
...
public:
  ...
  virtual int step();
  void  init_dut();
  void  update_dut(int count);
  void  update_Udut(int count);
  int  update_dut_discontinue(int count);
